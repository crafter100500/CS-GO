...
<html>
<?php 
	$c = mysqli_connect('mysql.09-15-pn.myjino.ru', '09-15-pn', 'it12345', '09-15-pn_maksim-nikulin');
		...
		<div class="col-4 p-5">
			<div class="col-12 bg-white p-3">
				<form action="check.php" method="GET">			
					<input placeholder="Телефон или email" type="" name="name" class="form-control">
					<input placeholder="Пароль" type="password" name="passowrd" class="form-control mt-3">
